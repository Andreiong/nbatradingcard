...
<div class="modal fade" id="cancelmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <a href="#" id="trans-btn" class="icon-a"><i class="fa fa-shopping-bag icons"></i> &nbsp;&nbsp;Paid<span class="fa fa-caret-down second"></span></a>
        <ul class="trans-show">
...
<div id="main">
    ...
    <div class="head">
        <div class="col-div-6">
<span style="font-size:25px;cursor:pointer; color: white;" class="nav"  >&#9776; Paid Orders</span>
<span style="font-size:25px;cursor:pointer; color: white;" class="nav2"  >&#9776;Paid Orders</span>
</div>
...
<table>
 ...
 include("includes/db.inc.php");
    ...
    $sql = "SELECT * FROM tblorders WHERE status = 'Paid' ORDER by order_id DESC";
