...
<body>
	<?php
    if(isset($_SESSION['exist_limited'])){ ?>
           <p class="failed"></p>
       <div class="failed hide">
         <i class="fa fa-times-circle" aria-hidden="true"></i>
         <span class="msg"><?php echo $_SESSION['exist_limited'];?></span>
         <div id="close-btn">
    ...
    <?php } ?>
     ...
     <?php
    if(isset($_SESSION['edit_limited'])){ ?>
        <p class="popup"></p>
       <div class="success hide">
         <i class="fa fa-check-circle" aria-hidden="true"></i>
         <span class="msg"><?php echo $_SESSION['edit_limited'];?></span>
         <div class="close-btn">
             <i class="fa fa-times" aria-hidden="true"></i>
         </div>
         </div>
    ...
    <?php } ?>
     ...
     <?php
    if(isset($_SESSION['limited_removed'])){ ?>
        <p class="popup"></p>
       <div class="success hide">
         <i class="fa fa-check-circle" aria-hidden="true"></i>
         <span class="msg"><?php echo $_SESSION['limited_removed'];?></span>
         <div class="close-btn">
             <i class="fa fa-times" aria-hidden="true"></i>
         </div>
         </div>
    ...
    <?php } ?>
    <?php
    unset($_SESSION['exist_limited']);
     unset($_SESSION['edit_limited']);
      unset($_SESSION['limited_removed']);
    ?>
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <a href="#" id="cat-btn" class="icon-a"><i class="fa fa-list icons"></i> &nbsp;&nbsp;Limited Edition<span class="fa fa-caret-down third"></span></a>
        <ul class="cat-show">
...
<div id="main">
	...
	<div class="head">
		<div class="col-div-6">
<span style="font-size:25px;cursor:pointer; color: white;" class="nav"  >&#9776; Limited Edition</span>
<span style="font-size:25px;cursor:pointer; color: white;" class="nav2"  >&#9776; Limited Edition</span>
</div>
...
<table>
 ...
 include("includes/db.inc.php");
    ...
    $sql = "SELECT * FROM tblcategory WHERE category_info = 'limited' ORDER by cat_id DESC";
