...
<form action="includes/update_category.inc.php" method="post">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Item Delivered?</label>
     <input type="hidden"  name="order_id" id="order_id">
  </div>
<div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="submit" name="delivered_status" class="btn btn-primary">Delivered</button>
         </div>
     </div>
</form> 
    </div>
...
<div class="modal fade" id="cancelmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <a href="#" id="trans-btn" class="icon-a"><i class="fa fa-shopping-bag icons"></i> &nbsp;&nbsp;Delivered<span class="fa fa-caret-down second"></span></a>
        <ul class="trans-show">
...
<div id="main">
    ...
    <div class="head">
        <div class="col-div-6">
<span style="font-size:25px;cursor:pointer; color: white;" class="nav"  >&#9776; Order Delivered</span>
<span style="font-size:25px;cursor:pointer; color: white;" class="nav2"  >&#9776; Order Delivered</span>
</div>
...
<table>
 ...
 include("includes/db.inc.php");
    ...
    $sql = "SELECT * FROM tblorders WHERE status = 'Delivered' ORDER by order_id DESC";
 ...
 ?>  
     <tr id="limited">
         ...
         <td><?php echo $date;?></td>
          <td><button type="button"  id="done" disabled=""><?php echo $status?></button></td>
         </tr>
     <?php }?>
    </tbody>
    </table>    
