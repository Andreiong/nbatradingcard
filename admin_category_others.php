...
<body>
	<?php
    if(isset($_SESSION['exist_others'])){ ?>
        <p class="failed"></p>
       <div class="failed hide">
         <i class="fa fa-check-circle" aria-hidden="true"></i>
         <span class="msg"><?php echo $_SESSION['exist_others'];?></span>
         <div id="close-btn">
    ...
    <?php } ?>
      ...
      <?php
    if(isset($_SESSION['edit_others'])){ ?>
        <p class="popup"></p>
       <div class="success hide">
         <i class="fa fa-check-circle" aria-hidden="true"></i>
         <span class="msg"><?php echo $_SESSION['edit_others'];?></span>
         <div class="close-btn">
             <i class="fa fa-times" aria-hidden="true"></i>
         </div>
         </div>
    ...
    <?php } ?>
     <?php
    if(isset($_SESSION['others_removed'])){ ?>
        <p class="popup"></p>
       <div class="success hide">
         <i class="fa fa-check-circle" aria-hidden="true"></i>
         <span class="msg"><?php echo $_SESSION['others_removed'];?></span>
         <div class="close-btn">
             <i class="fa fa-times" aria-hidden="true"></i>
         </div>
         </div>
    ...
    <?php } ?>
    <?php
    unset($_SESSION['exist_others']);
     unset($_SESSION['edit_others']);
      unset($_SESSION['others_removed']);
    ?>
    <!-- EDIT MODAL -->
...
<div class="modal-footer">
        ...
        <button type="submit" name="update_others_category" class="btn btn-primary">Update</button>
         </div>
     </div>
</form> 
    </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="submit" name="remove_others_category" class="btn btn-primary">Remove</button>
         </div>
    </form>
  ...
  <a href="#" id="cat-btn" class="icon-a"><i class="fa fa-list icons"></i> &nbsp;&nbsp;Others<span class="fa fa-caret-down third"></span></a>
        <ul class="cat-show">
...
<div id="main">
	...
	<div class="head">
		<div class="col-div-6">
<span style="font-size:25px;cursor:pointer; color: white;" class="nav"  >&#9776; Others</span>
<span style="font-size:25px;cursor:pointer; color: white;" class="nav2"  >&#9776; Others</span>
</div>
...
<table>
 ...
 include("includes/db.inc.php");
    ...
    $sql = "SELECT * FROM tblcategory WHERE category_info = 'others' ORDER by cat_id DESC";
