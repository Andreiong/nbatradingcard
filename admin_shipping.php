...
<body>
    ...
    if(isset($_SESSION['delivery_success'])){ ?>
       ...
       <div class="success hide">
         ...
         <span class="msg"><?php echo $_SESSION['delivery_success'];?></span>
         <div class="close-btn">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Confirm Delivered Product</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
<form action="includes/update_category.inc.php" method="post">
    <div class="modal-body">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Waiting for customer confirmation</label>
     <input type="hidden"  name="order_id" id="order_id">
  </div>
<div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="submit" name="delivered_status" class="btn btn-primary">Continue</button>
         </div>
     </div>
</form> 
    </div>
...
<div class="modal fade" id="cancelmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="submit" name="cancel_shipping" class="btn btn-primary">Continue</button>
         </div>
    </form>
  ...
  <a href="#" id="trans-btn" class="icon-a"><i class="fa fa-shopping-bag icons"></i> &nbsp;&nbsp;Shipping<span class="fa fa-caret-down second"></span></a>
        <ul class="trans-show">
...
<div id="main">
	...
	<div class="head">
		<div class="col-div-6">
<span style="font-size:25px;cursor:pointer; color: white;" class="nav"  >&#9776; Shipping Orders</span>
<span style="font-size:25px;cursor:pointer; color: white;" class="nav2"  >&#9776; Shipping Orders</span>
</div>
...
<table>
 ...
 include("includes/db.inc.php");
    ...
    $sql = "SELECT * FROM tblorders WHERE status = 'Shipping' ORDER by order_id DESC";
 ...
 ?>  
     <tr id="limited">
         ...
         <td><button type="button" id="remove" class="btn btn-danger cancelbtn">Cancel</button></td>
          <td><button type="button" id="edit" class="btn btn-danger deliveredbtn">Delivered</button></td>
         </tr>
     <?php }?>
    </tbody>
    </table>    
